...
def collapse_H_to_heavy(smiles: str, atom_imp_withHs):
    """
    atom_imp_withHs: list/1D tensor length = num atoms in Chem.AddHs(mol)
    Returns:
      mol_noHs: RDKit mol without explicit Hs
      heavy_imp: list length = num heavy atoms
    """
